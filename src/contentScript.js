...
document.getElementById("ctl00_ContentPlaceHolder1_txtMaleAge").value = data[0].male_children_ages;
document.getElementById("ctl00_ContentPlaceHolder1_txtFemaleAge").value = data[0].female_children_ages;
